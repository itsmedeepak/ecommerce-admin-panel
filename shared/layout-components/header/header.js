        ...
        <Container fluid className="main-container container-fluid">
          <div className="main-header-left">
            ...
            <div className="hor-logo">
              <Link href="/components/dashboard/dashboard">
                ...
                <img src={logo.src} className="header-brand-img desktop-logo" alt="logo" height={100} />
                <img src={logo.src} className="header-brand-img desktop-logo-dark" alt="logo" height={100}/>
                </a>
              </Link>
            </div>
          </div>
          <div className="main-header-center">
            <div className="responsive-logo">
              <Link href="/components/dashboard/dashboard">
                <a>
                <img src={logo.src} className="mobile-logo" alt="logo" height={40}/>
                </a>
              </Link>
              <Link href="/components/dashboard/dashboard">
                <a>
                <img src={logolight.src} className="mobile-logo-dark" alt="logo" height={40} />
                </a>
              </Link>
            </div>
