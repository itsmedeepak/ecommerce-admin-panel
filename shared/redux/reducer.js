...
export default function reducer(state = Productdata, action) {
  ...
  function primaryOpacityVaue() {
    ...
    //get variable
    let myVarVal =
      localStorage.getItem("PatalgoprimaryColor") ||
      localStorage.getItem("PatalgodarkPrimary") ||
      primaryColorVal;
  ...
  switch (type) {
    ...
    case "lightPrimaryColor":
      ...
      localStorage.setItem("PatalgoprimaryColor", userColor);
      // to store value as opacity 0.95 we use 95
      localStorage.setItem("PatalgoprimaryHoverColor", userColor + 95);
      localStorage.setItem("PatalgoprimaryBorderColor", userColor);
      localStorage.setItem("PatalgoprimaryTransparent", userColor + 20);
      // localStorage.setItem("PatalgoprimaryTransparent", userColor + 20);
      ...
      // Removing
      document.querySelector("body")?.classList.remove("dark-theme");
      localStorage.removeItem("PatalgodarkPrimaryColor");
      localStorage.removeItem("PatalgodarkprimaryTransparent");
      primaryOpacityVaue();
      break;
    case "darkPrimaryColor":
      var userColor = document.getElementById("darkPrimaryColorID").value;
      localStorage.setItem("PatalgodarkPrimary", userColor);
      localStorage.setItem("PatalgodarkprimaryTransparent", userColor + 20);
      ...
      localStorage.removeItem("PatalgoprimaryColor");
      localStorage.removeItem("PatalgoprimaryHoverColor");
      localStorage.removeItem("PatalgoprimaryBorderColor");
      localStorage.removeItem("PatalgoprimaryTransparent");
      break;
    default:
      return state;
  }
