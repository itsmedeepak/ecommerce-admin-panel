...
export const LtrtoRtl = () => {
    ...
    localStorage.setItem('PatalgoLtrtoRtl', true)
    localStorage.removeItem('PatalgoRtltoLtr')
  };
  //RTL TO LTR
  export const RtltoLtr = () => {
    ...
    localStorage.setItem('PatalgoRtltoLtr', true);
    localStorage.removeItem('PatalgoLtrtoRtl');
  };
  //LIGHTHEADER
  ...
  export const VerticalMenu = () => {
    ...
    localStorage.setItem('Patalgovertical', true)
    localStorage.removeItem('Patalgohorizontal')
    localStorage.removeItem('Patalgohorizontalhover')
  };
  export const Horizontal = () => {
    ...
    if(document.querySelector('.main-container-1')!= null){
      ...
      switcherArrowFn();
      localStorage.setItem('Patalgohorizontal', true)
      localStorage.removeItem('Patalgovertical')
      localStorage.removeItem('Patalgohorizontalhover')
    }
  };
  export const HorizontalHoverMenu = () => {
    ...
    if(document.querySelector('.main-menu') != null){
      ...
      Horizontalmenudefultclose();
      switcherArrowFn();
      localStorage.setItem('Patalgohorizontalhover', true)
      localStorage.removeItem('Patalgohorizontal')
      localStorage.removeItem('Patalgovertical')
    }
  };
  ...
  export const LightTheme = () => {
    ...
    primaryOpacityVaue();
    // localStorage.clear();
    localStorage.setItem('PatalgoLighttheme', true);
    localStorage.removeItem('Patalgodark')
  };
  export const dark = () => {
    ...
    primaryOpacityVaue();
    // localStorage.clear();
    localStorage.removeItem('PatalgoLighttheme');
    localStorage.setItem('Patalgodark', true)
  };
  ...
  export function primaryOpacityVaue() {
    let primaryColorVal = getComputedStyle(document.documentElement)
      ...
      .trim();
    //get variable
    let myVarVal = localStorage.getItem("PatalgoprimaryColor") || localStorage.getItem("PatalgodarkPrimary") || primaryColorVal;
  ...
  export function localStorageBackUp() {
    ...
    if (localStorage.getItem("PatalgoprimaryColor") !== null) {
      body?.classList.add("light-theme");
      document.getElementById("myonoffswitch6").checked = true;
      body?.classList.remove("dark-theme");
      html?.setProperty("--primary-bg-color", localStorage.getItem("PatalgoprimaryColor"));
      html?.setProperty("--primary-bg-hover", localStorage.getItem("PatalgoprimaryHoverColor"));
      html?.setProperty("--primary-bg-border", localStorage.getItem("PatalgoprimaryBorderColor"));
    }
    if (localStorage.getItem("PatalgodarkPrimary") !== null) {
      body?.classList.add("dark-theme");
      body?.classList.remove("light-theme");
      html?.setProperty("--primary-bg-color", localStorage.getItem("PatalgodarkPrimary"));
      html?.setProperty("--primary-bg-hover", localStorage.getItem("PatalgodarkPrimary"));
      html?.setProperty("--primary-bg-border", localStorage.getItem("PatalgodarkPrimary"));
    }
    if (localStorage.getItem('Patalgohorizontal')) {
      Horizontal()
      document.querySelector("#myonoffswitch02").checked = true;

    }

    if (localStorage.getItem('Patalgohorizontalhover') !== null) {
      HorizontalHoverMenu()
      document.querySelector("#myonoffswitch03").checked = true;
    }

    if (localStorage.getItem('PatalgoLtrtoRtl')) {
      LtrtoRtl()
      document.querySelector("#myonoffswitch20").checked = true;
    }
    if (localStorage.getItem('Patalgodark') !== null) {
      dark()
