    ...
    },
    {
      ...
      cell: row =>
        <div className="d-flex my-auto">
          ...
          <span className="my-auto">${row.total / 100}</span>
        </div>,
    ...
    },
    {
      ...
      cell: row =>
        <div className="font-weight-semibold">
          <Link href={row.hosted_invoice_url ? row.hosted_invoice_url : "#"} style={{ textDecoration: "none", color: "white" }}> Invoice</Link>
        </div>
...
export async function getServerSideProps({req, res}) {
  ...
  // console.log(data)
  return { props: { product: JSON.parse(JSON.stringify(orders)) ,user: JSON.parse(JSON.stringify(user))} }
}
